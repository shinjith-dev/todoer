...
export default async function Home() {
  ...
  return (
    <div className="pt-12 sm:pt-16 md:pt-20 space-y-6">
      <div className="py-10 text-center sm:py-14 md:py-16 lg:py-20">
        <h3 className="mx-auto mb-2 max-w-[240px] text-2xl font-bold tracking-tight sm:max-w-[300px] sm:text-3xl md:mb-4 md:max-w-sm md:text-4xl lg:max-w-xl lg:text-5xl xl:max-w-2xl xl:text-6xl">
